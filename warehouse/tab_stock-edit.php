...
public function page_content() {
    ...
    $tpl->display("tab_stock-edit.tpl");
} // EO page_content
function process_form() {
    ...
    try {
        $DB->beginTransaction();
        DBC::execute("UPDATE warehouseinfo SET STOCKITEM=:stockitem,ABCCLASS=:abcclass,REORDERPOINT=:reorderpoint,REORDERQTY=:reorderqty,REORDERMETHOD=:reordermethod,MINSTOCKLEVEL=:minstocklevel WHERE ITEMNUM=:itemnum AND WAREHOUSEID='DEFAULT'",array("itemnum"=>$_REQUEST['id1'],"stockitem"=>$_REQUEST['STOCKITEM'],"abcclass"=>$_REQUEST['ABCCLASS'],"reorderpoint"=>$_REQUEST['REORDERPOINT'],"minstocklevel"=>$_REQUEST['MINSTOCKLEVEL'],"reorderqty"=>$_REQUEST['REORDERQTY'],"reordermethod"=>$_REQUEST['REORDERMETHOD']));
