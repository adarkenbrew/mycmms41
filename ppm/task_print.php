...
//$checks=$DB->query("SELECT INDICATOR AS 'DBFLD_INDICATOR',INDICATOR_TYPE 'DBFLD_INDICATOR_TYPE',LABEL AS 'DBFLD_LABEL',DESCRIPTION AS 'DBFLD_DESCRIPTION' FROM tskchecks WHERE TASKNUM='$TASKNUM'",PDO::FETCH_ASSOC);
