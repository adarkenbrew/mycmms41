...
<input type="hidden" name="ID" value="{$check.INDICATOR}">
    <td>{$check.INDICATOR}</td>
    <td>{include file="_combobox_num.tpl" options=$indicator_types NAME="TYPE" SELECTEDITEM=$check.TYPE}</td>
...
<input type="hidden" name="form_save" value="SET">
    ...
    <td>{include file="_combobox_num.tpl" options=$indicator_types NAME="TYPE" SELECTEDITEM=""}</td>
