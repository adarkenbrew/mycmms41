...
<tr><td align="center">{include file="_combobox.tpl" options=$names NAME="uid" SELECTEDITEM=""}</td>
    <td align="center"><input type="password" name="passwd" class="input" size="10"></td></tr>
