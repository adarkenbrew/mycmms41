...
<table width="600">
<tr><td align="right">{t}Stock Location{/t}</td>
    <td><input type="text" name="LOCATION" size="10" value="{$data.LOCATION}"></td></tr>
<tr><td align="right">{t}Stock Item{/t}&nbsp<input type="text" name="STOCKITEM" size="5" value="{$data.STOCKITEM}"></td>
    <td><input type="text" name="ABCCLASS" size="5" value="{$data.ABCCLASS}">&nbsp{t}ABC Class{/t}</td></tr>
<tr><td align="right">{t}ReOrder Point{/t}&nbsp<input type="text" name="REORDERPOINT" size="5" value="{$data.REORDERPOINT}"></td>
    <td><input type="text" name="REORDERQTY" size="5" value="{$data.REORDERQTY}">&nbsp{t}ReOrder Quantity{/t}</td></tr>
<tr><td align="right">{t}Minimum Stock Level{/t}&nbsp<input type="text" name="MINSTOCKLEVEL" size="5" value="{$data.MINSTOCKLEVEL}"></td>
