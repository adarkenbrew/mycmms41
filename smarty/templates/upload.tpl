...
<tr class="smallheader" valign="middle">
    <td align="left" class="smallheader"><span class="title">myCMMS file linker to object {$object}</span></td>
</tr>
</table>
</td></tr>
...
<table width="100%" cellspacing="0" cellpadding="1" border="0">
    <tr><td colspan=2>Directory: <b>{$path}</b></td></tr>
</table>
</td></tr>
</table>
<br/>
...
<tr class="{if $smarty.section.j.iteration is odd}item0{else}item1{/if}">
    <td><a href="{$index}?file={$path}{$files[j][0]}&setlink=Y"><img src="../images/files/{$files[j][1]}" border="0" width="16" height="16" />&nbsp;{$files[j][0]}</a></td><td>...</td></tr>
{/section}

{foreach item=taskdocu from=$taskdocs}
<tr bgcolor="{cycle values="{#TREE_LINECOLOR_EVEN#},{#TREE_LINECOLOR_ODD#}"}">
