...
<input type="hidden" name="EQNUM" value="{$smarty.session.dept}">
<input type="hidden" name="ORIGINATOR" value="{$smarty.session.user}">
<table width="800">
...
<tr><td align="right">{t}DBFLD_EQNUM{/t}</a></td>
    <td>{$smarty.session.dept}</td></tr>
<tr><td colspan="2">    
